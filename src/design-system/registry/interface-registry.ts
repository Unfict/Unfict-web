...
export const INTERFACE_REGISTRY: readonly InterfaceRegistryRecord[] = [
  ...
  },
  {
    ...
    authorityConfidence: 'OPERATIVE',
    visualEvidence: 'REFERENCE_PAGE_ACCEPTED',
    sources: ['UIS', 'STITCH-UNFICT-HOME-01', 'STITCH-UNFICT-GS1-PILLAR-01'],
    sourceCompositions: ['COMPOSITION-HOME-01', 'COMPOSITION-GS1-PILLAR-01'],
  ...
  },
  {
    ...
    authorityConfidence: 'PROVISIONAL',
    visualEvidence: 'REFERENCE_PAGE_ACCEPTED',
    sources: ['UIS', 'STITCH-UNFICT-GS1-PILLAR-01'],
    sourceCompositions: ['COMPOSITION-GS1-PILLAR-01'],
