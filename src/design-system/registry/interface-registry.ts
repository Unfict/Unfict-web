...
export const INTERFACE_REGISTRY: readonly InterfaceRegistryRecord[] = [
  ...
  },
  {
    ...
    sourceCompositions: ['COMPOSITION-HOME-01'],
  ...
  },
  {
    ...
    authorityConfidence: 'OPERATIVE',
    visualEvidence: 'REFERENCE_PAGE_ACCEPTED',
    sources: ['UIS', 'LEGACY-REG', 'HOME-LEGACY', 'GS1-LEGACY'],
    sourceCompositions: ['HOME-LEGACY', 'GS1-LEGACY'],
  ...
  },
  {
    ...
    authorityConfidence: 'OPERATIVE',
    visualEvidence: 'REFERENCE_PAGE_ACCEPTED',
    sources: ['UIS', 'LEGACY-REG', 'HOME-LEGACY', 'GS1-LEGACY', 'FAQ-LEGACY'],
    sourceCompositions: ['HOME-LEGACY', 'GS1-LEGACY', 'FAQ-LEGACY'],
